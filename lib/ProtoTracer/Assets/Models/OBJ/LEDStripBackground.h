...
private:
	Vector3D basisVertices[4] = {Vector3D(1000.0000f,-1000.0000f,0.0000f),Vector3D(1000.0000f,1000.0000f,0.0000f),Vector3D(800.0000f,1000.0000f,0.0000f),Vector3D(800.0000f,-1000.0000f,0.0000f)};
