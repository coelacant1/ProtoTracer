/**
 * @file RainbowNoise.h
 * @brief A dynamic material generating a rainbow effect using simplex noise.
 *
 * This file defines the RainbowNoise class, which uses simplex noise combined
 * with a gradient material to create a dynamic, flowing rainbow effect.
 *
 * @date 22/12/2024
 * @author Coela Can't
 */
...
/**
 * @class RainbowNoise
 * @brief A dynamic material that creates a rainbow effect using simplex noise.
 *
 * The RainbowNoise class combines simplex noise with a gradient material to
 * produce a dynamic, colorful effect that shifts over time.
 */
...
private:
    ...
    RGBColor noiseSpectrum[4] = {RGBColor(0, 255, 0), RGBColor(255, 0, 0), RGBColor(0, 255, 0), RGBColor(0, 0, 255)}; ///< Spectrum for the gradient.
...
public:
    /**
     * @brief Default constructor for RainbowNoise.
     */
    RainbowNoise() {}
