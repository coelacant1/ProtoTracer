/**
 * @file WS35Controller.h
 * @brief Declares the WS35Controller class for managing WS2812-based displays on the Delta, Epsilon, and Sigma Protogen heads.
 *
 * This file defines the WS35Controller class, which extends the Controller base class.
 * It provides functionality for controlling and displaying content on two WS35 WS2812-based displays
 * designed for the Delta, Epsilon, and Sigma Protogen heads.
 *
 * @date 22/12/2024
 * @author Coela Can't
 */
 ...
 * @brief Manages WS2812-based displays for the Delta, Epsilon, and Sigma Protogen heads.
 *
 * The WS35Controller class extends the Controller base class to provide specific
...
public:
    /**
     * @brief Constructs a WS35Controller with specified parameters.
     *
    ...
    /**
     * @brief Initializes the WS35Controller and sets up the displays.
     */
