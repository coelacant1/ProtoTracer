...
private:
    ...
    FunctionGenerator fGenScale = FunctionGenerator(FunctionGenerator::Sine, 0.5f, 0.75f, 4.2f);
...
public:
    ...
    void Update(float ratio) override {
        ...
        creeper.GetObject()->GetTransform()->SetScale(Vector3D(sx, sx, sx));
        //spyro.GetObject()->GetTransform()->SetScaleOffset(Vector3D(100.0f, 75.0f, 0.0f));
        creeper.GetObject()->GetTransform()->SetPosition(Vector3D(0.0f, px - 100.0f, 600.0f));
