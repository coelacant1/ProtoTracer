...
public:
    ...
    void Display() override {
        ...
        for (int i = 0; i < 571; i++) {
            if (i < 346){
                //Rear Panels
                leds.setPixel(i + 346 * 6, camLeftRearPixels.GetPixel(i + 225)->Color.R, camLeftRearPixels.GetPixel(i + 225)->Color.G, camLeftRearPixels.GetPixel(i + 225)->Color.B);//Pin 7
                leds.setPixel(i + 346 * 7, camRghtRearPixels.GetPixel(i)->Color.R, camRghtRearPixels.GetPixel(i)->Color.G, camRghtRearPixels.GetPixel(i)->Color.B);//Pin 8

                //Front Panels
                leds.setPixel(i + 346 * 2, camLeftFrntPixels.GetPixel(i + 225)->Color.R, camLeftFrntPixels.GetPixel(i + 225)->Color.G, camLeftFrntPixels.GetPixel(i + 225)->Color.B);//Pin 7
                leds.setPixel(i + 346 * 3, camRghtFrntPixels.GetPixel(i)->Color.R, camRghtFrntPixels.GetPixel(i)->Color.G, camRghtFrntPixels.GetPixel(i)->Color.B);//Pin 8
            }
            else{
                //Rear Panels
                leds.setPixel(i + 346 * 4 - 346, camLeftRearPixels.GetPixel(i - 346)->Color.R, camLeftRearPixels.GetPixel(i - 346)->Color.G, camLeftRearPixels.GetPixel(i - 346)->Color.B);//Pin 8
                leds.setPixel(i + 346 * 5 - 346, camRghtRearPixels.GetPixel(i)->Color.R, camRghtRearPixels.GetPixel(i)->Color.G, camRghtRearPixels.GetPixel(i)->Color.B);//Pin 8

                //Front Panels
                leds.setPixel(i + 346 * 0 - 346, camLeftFrntPixels.GetPixel(i - 346)->Color.R, camLeftFrntPixels.GetPixel(i - 346)->Color.G, camLeftFrntPixels.GetPixel(i - 346)->Color.B);//Pin 8
                leds.setPixel(i + 346 * 1 - 346, camRghtFrntPixels.GetPixel(i)->Color.R, camRghtFrntPixels.GetPixel(i)->Color.G, camRghtFrntPixels.GetPixel(i)->Color.B);//Pin 8
            }
        }
        
        for(int i = 0; i < 89; i++){
            //Front Panels
            leds.setPixel(i + 346 * 0 + 225, camLeftChinPixels.GetPixel(i)->Color.R, camLeftChinPixels.GetPixel(i)->Color.G, camLeftChinPixels.GetPixel(i)->Color.B);//Pin 8
            leds.setPixel(i + 346 * 1 + 225, camRghtChinPixels.GetPixel(i)->Color.R, camRghtChinPixels.GetPixel(i)->Color.G, camRghtChinPixels.GetPixel(i)->Color.B);//Pin 8
        }
