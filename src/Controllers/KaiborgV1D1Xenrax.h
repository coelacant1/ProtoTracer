...
private:
    ...
    Transform camFinTransform = Transform(Vector3D(), Vector3D(0, 0, -500.0f), Vector3D(1, 1, 1));
    Transform camSquTransform = Transform(Vector3D(), Vector3D(0, 0, -500.0f), Vector3D(1, 1, 1));
    Transform camRinTransform = Transform(Vector3D(), Vector3D(0, 0, -500.0f), Vector3D(1, 1, 1));
...
public:
    KaiborgV1D1Controller(uint8_t maxBrightness) : Controller(cameras, 5, maxBrightness, 0){}
