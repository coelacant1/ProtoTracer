...
void loop() {
  for (int i = 0; i < 720; i++) {
    ...
    objects[0]->MoveRelative(Vector3D(-100 + sin(i * 3.14159f / 180.0f * 3.0f) * 100.0f, 60 + cos(i * 3.14159f / 180.0f * 1.5f) * 100.0f, 0.0f));
    ...
    for (int i = 0; i < 306; i++) {
      leds.setPixel(i,           camFrontTop.GetPixels()[i].Color.R,    camFrontTop.GetPixels()[i].Color.G,    camFrontTop.GetPixels()[i].Color.B);
      leds.setPixel(i + 306,     camRearTop.GetPixels()[i].Color.R,     camRearTop.GetPixels()[i].Color.G,     camRearTop.GetPixels()[i].Color.B);
      leds.setPixel(i + 306 * 2, camFrontBottom.GetPixels()[i].Color.R, camFrontBottom.GetPixels()[i].Color.G, camFrontBottom.GetPixels()[i].Color.B);
      leds.setPixel(i + 306 * 3, camRearBottom.GetPixels()[i].Color.R,  camRearBottom.GetPixels()[i].Color.G,  camRearBottom.GetPixels()[i].Color.B);
    }
