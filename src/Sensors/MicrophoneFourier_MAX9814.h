...
private:
    ...
    static float AverageMagnitude(const uint16_t binL, const uint16_t binH) {
        float average = 0.0f;
...
public:
    static void Initialize(const uint8_t pin, const uint16_t sampleRate, const float minDB, const float maxDB) {
